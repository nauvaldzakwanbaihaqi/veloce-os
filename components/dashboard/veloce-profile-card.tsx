...
import { ShieldCheck, Terminal, Cpu, Wifi } from "lucide-react";
...
export function VeloceProfileCard({
  ...
  return (
    <Card className="relative overflow-hidden rounded-3xl border-0 shadow-sm shadow-blue-900/5 bg-gradient-to-b from-slate-900 via-slate-900 to-slate-950 text-white p-6 flex flex-col justify-between min-h-[220px]">
      {/* Background Subtle Grid Texture / Glow */}
      ...
      {/* Top Header: Session Badge & Terminal Icon */}
      <div className="relative z-10 flex items-center justify-between">
        <div className="flex items-center gap-2 px-3 py-1 rounded-full bg-blue-500/10 border border-blue-400/20 backdrop-blur-md text-blue-300 text-xs font-semibold">
      ...
      <div className="relative z-10 pt-6 space-y-3">
        <div className="flex items-center gap-3.5">
          <div className="relative">
            <div className="h-14 w-14 rounded-2xl bg-gradient-to-tr from-blue-600 to-indigo-500 p-0.5 shadow-lg shadow-blue-500/20">
        ...
        <div className="pt-2 border-t border-slate-800/80 flex items-center justify-between text-[11px] text-slate-400 font-mono">
          <span className="flex items-center gap-1">
            <Cpu className="h-3 w-3 text-blue-400" /> 8 Cores (ARM)
          </span>
          <span className="flex items-center gap-1">
            <Wifi className="h-3 w-3 text-emerald-400" /> Encrypted
          </span>
        </div>
      </div>
    </Card>
