...
export function BentoProfileCard({ userName, totalEarnings }: BentoProfileCardProps) {
  return (
    <Card className="relative overflow-hidden group border-0 shadow-lg shadow-blue-900/5 aspect-square sm:aspect-auto sm:h-full flex flex-col justify-end bg-gradient-to-b from-slate-100 to-slate-200 dark:from-slate-800 dark:to-slate-900">
